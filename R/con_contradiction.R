# source("/./home/anhptq/vaccine_reg_r/arrow_dqa_toolkit/util_mapping_compare.R") 
...
#'
#' @return list containing result summary (data.frame) and contradicted data (tibble)
